    ...
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MerchantID = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "特店編號,Ecpa提供"),
                    ReturnURL = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true, comment: "付款完成\r\n通知回傳\r\n網址"),
                    ChoosePayment = table.Column<int>(type: "int", nullable: false, comment: "1.Criedit 2. ATM"),
                    ClientBackURL = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true, comment: "返回指定網頁"),
                    ...
                    HashKey = table.Column<string>(type: "nchar(255)", fixedLength: true, maxLength: 255, nullable: true),
                    HashIV = table.Column<string>(type: "nchar(255)", fixedLength: true, maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalBuyCount = table.Column<int>(type: "int", nullable: false, comment: "此遊戲被購買次數"),
                    ReleaseState = table.Column<int>(type: "int", nullable: false, comment: "1.已發佈 2.尚未發佈"),
                    ...
                    Developer = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "開發商家"),
                    Marker = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "開發者")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HDDspace = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "硬碟使用空間"),
                    System = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "系統類別"),
                    SystemRam = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "記憶體"),
                    SystemCpu = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "處理器"),
                    SystemGpu = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "顯示卡"),
                    GameId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerService_AspNetUsers",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FriendList_AspNetUsers1",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true, comment: "被邀請者"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArticleLike_AspNetUsers1",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReplyLike_AspNetUsers1",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
