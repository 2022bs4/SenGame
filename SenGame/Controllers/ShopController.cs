...
namespace SenGame.Controllers
{
    public class ShopController : Controller
    {
        ...
        List<GameMedium> gameMedia = new List<GameMedium>()
        {
        ...
        {
            var media = gameMedia.Where(x => x.GameId == id && x.InstructionType == 1 && x.Instruction == 1).OrderBy(x => x.Sort).ToList();
            return Json(media);
        }
